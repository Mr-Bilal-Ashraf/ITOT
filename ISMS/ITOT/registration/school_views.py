...
from .serializers import ser_logo, ser_schedules, ser_schl_apps, ser_srch_school, ser_reg_classes, ser_reg_school, ser_reg_admin, ser_show_schl
...
def schl_list(request):
    ...
    resulted_schools = School.objects.filter(
        **srch_query).values("logo", "name", "address")
    da = []
